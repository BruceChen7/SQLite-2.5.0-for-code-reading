...
** page has a small header which contains the Ptr(N+1) pointer. // N+1个指针
**
** 文件的第一页，包含magic string, 和未用的页面
** 在第二页是root的页面
